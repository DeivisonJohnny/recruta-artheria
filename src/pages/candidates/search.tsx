...
import { Search, MapPin, Code, FileText, Loader2, ExternalLink, UserCircle2 } from 'lucide-react';
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(data.message || 'Erro ao realizar pesquisa');
      }
    } catch (error) {
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Pesquisar Candidatos</h1>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
            ...
            <div className="space-y-3">
              {results.map((result, index) => (
                <div
                  key={index}
                  className="flex items-center justify-between p-5 border border-gray-200 rounded-xl hover:bg-gray-50 hover:border-blue-300 transition-all"
                >
                  ...
                  <button
                    onClick={() => router.push(`/candidates/${result.linkedinId}`)}
        ...
        {loading && (
          <div className="bg-white rounded-2xl border border-gray-200 p-12 text-center shadow-sm">
            ...
            <p className="text-lg font-medium text-gray-900 mb-2">Buscando perfis no LinkedIn...</p>
